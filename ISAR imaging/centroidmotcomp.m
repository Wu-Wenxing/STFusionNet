%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Range and Doppler centroid for motion compensation
%
% Input:
%   Rx: simulated step-frequency data (freq steps X bursts)
%   fo: center freq.
%   Df: freq. step
%   t0: time interval between adjacent pulses
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear all
close all
...
ylabel('Pulses')
xlabel('Range cells')
title('Range profiles after Range Centroid')
axis('xy')
clim = get(gca,'CLim');
